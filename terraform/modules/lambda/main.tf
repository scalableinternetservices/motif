...
# Lambda URIs are "{+lambda}/{+function}" e.g. "motif/ping".
# We also support path matching at the root e.g. "motif" but these require definining separate "_root" terraform resources.

...
usage="Usage: deploy-ecs.sh [motif-app-web|motif-app-background] [sha]"
...
new_image="101624687637.dkr.ecr.us-west-2.amazonaws.com/motif:$2"
...
aws ecs update-service --cluster motif \
  --no-cli-pager \
  --region "$ecs_region" \
